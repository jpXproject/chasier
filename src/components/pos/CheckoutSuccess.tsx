    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm anim-fade">
      <div className="card w-full max-w-sm mx-4 p-6">
        ...
        <div className="flex flex-col items-center gap-2 mb-5">
          ...
          >
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="var(--green)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Receipt */}
        <div
          className="p-4 rounded-xl space-y-2 text-xs mb-5"
        ...
        <button onClick={onNewOrder} className="btn-primary w-full py-3.5 text-sm font-700">
          Order Baru
        </button>
      </div>
    </div>
